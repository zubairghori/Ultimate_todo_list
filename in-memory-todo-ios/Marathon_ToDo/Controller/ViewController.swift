...
class ViewController: ButtonBarPagerTabStripViewController {
    ...
    func loadDesign(){
        ...
        self.settings.style.selectedBarHeight =  50
        self.settings.style.selectedBarBackgroundColor = UIColor.black
        self.settings.style.buttonBarBackgroundColor = UIColor(red: 139/255, green: 210/255, blue: 125/255, alpha: 1)
        self.settings.style.buttonBarItemBackgroundColor = UIColor(red: 139/255, green: 210/255, blue: 125/255, alpha: 1)
