...
app.config[
    'SQLALCHEMY_DATABASE_URI'] = 'postgres://nwabmkhn:Ckfn-9UibDBRM1zM3Zji-WfQsSIyYSCc@pellefant.db.elephantsql.com:5432/nwabmkhn'
...
def add():  # add function.
    ...
    if (request.data):  # validation
        if "title" and "description" in added:  # if title and descption in json form
            ...
            return jsonify(
                {'prompt': 'Added successfully'}), 200  # return data in jsonify format and successfully added
